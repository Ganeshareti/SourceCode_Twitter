...
def load_data():
    ...
    """
    data = pd.read_csv(r"E:\MY_PROJECTS\SourceCode_Twitter\Detection\dataset\twitter_dataset.csv",encoding='latin-1')
...
def dl_evaluation_process():
    ...
    model.fit(X_train, y_train, epochs=5, verbose=1, validation_data=(X_test, y_test), batch_size=64)
    #print("saving")
